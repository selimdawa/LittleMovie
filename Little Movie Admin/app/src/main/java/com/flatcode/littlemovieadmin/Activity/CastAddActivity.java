...
public class CastAddActivity extends AppCompatActivity {

    private ActivityCastAddBinding binding;
    Activity activity = CastAddActivity.this;
    ...
    private void uploadToStorage() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference(DATA.CAST);
        String id = ref.push().getKey();

        String filePathAndName = "Images/Cast/" + id;
    ...
    private void uploadInfoDB(String uploadedImageUrl, String id, DatabaseReference ref) {
        ...
        hashMap.put(DATA.MOVIES_COUNT, DATA.ZERO);

        //db reference: DB > Cast
        assert id != null;
