...
public class MyCategoriesActivity extends AppCompatActivity {
    ...
    private ActivityMyCategoriesBinding binding;
    Activity activity = MyCategoriesActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMyCategoriesBinding.inflate(getLayoutInflater());
        ...
        binding.switchBar.explore.setOnClickListener(v -> VOID.Intent(activity, CLASS.CATEGORIES));
